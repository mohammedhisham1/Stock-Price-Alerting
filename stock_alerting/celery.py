...
app.conf.beat_schedule = {
    'fetch-stock-prices': {
        ...
        # 'schedule': crontab(minute='*/2'),  # Every 30 min during market hours (Mon-Fri, 9-16 UTC)
        'schedule': crontab(minute='*/2', hour='9-16', day_of_week='1-5'),  # Every 30 min during market hours (Mon-Fri, 9-16 UTC)
    },
    'evaluate-alerts': {
